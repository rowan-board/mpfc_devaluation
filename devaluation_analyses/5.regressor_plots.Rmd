...
a <- read.csv("data/main/sub_02/raw1_02.csv") %>%
  select(!contains("fives")) 
a['subject_nr'] <- nr_s[1]
b <- read.csv("data/main/sub_02/raw2_02.csv") %>%
  select(!contains("fives"))
b['subject_nr'] <- nr_s[1]
...
for (i in 2:21){
file_1 <- str_replace_all("data/main/sub_02/raw1_02.csv",'02',nr_s[i])
file_2 <- str_replace_all("data/main/sub_02/raw2_02.csv",'02',nr_s[i])
